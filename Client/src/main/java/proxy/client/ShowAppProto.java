...
import protobuff_protocol.ProtoClientService;
import proxy.client.ui.LoginController;
import services.MainServerServiceInterface;

import java.util.Properties;

public class ShowAppProto extends Application {
    private Stage stage;
    ...
    @Override
    public void start(Stage primaryStage) throws Exception { // PROTO-SERVER
        initializeProperties();
        MainServerServiceInterface service = new ProtoClientService(serverIP,serverPort);
